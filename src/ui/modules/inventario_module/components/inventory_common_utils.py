...
from PyQt6.QtWidgets import (
    ...
    QTextEdit, QCheckBox, QGroupBox, QFrame, QScrollArea,
...
class InventoryDialogBase(QDialog):
    ...
    def create_form_field(self, label: str, widget: QWidget, 
                         required: bool = False) -> Tuple[QLabel, QWidget]:
...
class InventoryManagerBase(QWidget):
    ...
    def setup_table_columns(self, headers: List[str], widths: Optional[List[int]] = None):
...
class InventoryValidationUtils:
    ...
    def validate_numeric_field(value: str, field_name: str, 
                             min_val: float = 0, max_val: Optional[float] = None) -> Tuple[bool, str]:
    ...
    def validate_text_length(value: str, field_name: str, 
                           min_length: int = 1, max_length: int = 255) -> bool:
    ...
    @staticmethod
    def validate_unique_field(value: str, existing_values: List[str], 
                            field_name: str, ignore_value: str = None) -> Tuple[bool, str]:
