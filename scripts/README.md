# 🛠️ scripts - Utilidades y Automatización
...
```
scripts/
├── analysis/     # Scripts de análisis y depuración
...
- Solo se permiten scripts de utilidad, automatización, análisis, migración y testing manual.
- Nomenclatura esperada según el tipo de script y área.
...
- Ejecuta los scripts desde la raíz del proyecto según las instrucciones de cada subcarpeta.
