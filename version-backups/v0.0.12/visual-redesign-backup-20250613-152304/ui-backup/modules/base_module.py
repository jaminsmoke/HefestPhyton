    ...
    def __init__(self, parent=None):
        ...
        if purge_modern_css_from_widget_tree:
            try:
                ...
                logger.debug(f"CSS compatibility filter applied to {self.__class__.__name__}")
            except Exception as e:
                logger.warning(f"Failed to apply CSS compatibility filter to {self.__class__.__name__}: {e}")
