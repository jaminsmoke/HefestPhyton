...
"""
Filtro CSS INTELIGENTE para PyQt6 - Version SIMPLE y CORRECTA
...
def convert_to_qt_smart_css(css_code):
    ...
    _ = {
        ...
        # Gradientes CSS3 modernos - dejar como están los qlineargradient
        # Solo convertir los linear-gradient de CSS3
