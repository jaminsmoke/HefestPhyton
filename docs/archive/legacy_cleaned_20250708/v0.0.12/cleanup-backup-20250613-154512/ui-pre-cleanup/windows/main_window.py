...
# Dashboard Controller antiguo (mantener por compatibilidad temporal)
    ...
    def create_module_widget(self, module_id):
        ...
        try:
            ...
            if module_class:
                ...
                if module_id == "dashboard":                    return module_class(auth_service=self.auth_service, db_manager=self.db_manager)
                else:
                    return module_class()
            else:
    ...
    def get_module_class(self, module_id):
        ...
        if module_id in module_classes:
            ...
            if isinstance(class_path, str):
                ...
                # import importlib  # Used for safe dynamic imports
